            ...
            <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="icons.html" class="side-menu__item">
                        <i class="ri-emoji-sticker-line side-menu__icon"></i>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item active">
                        ...
                        <span class="side-menu__label">System Admin</span>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="chartjs-charts.html" class="side-menu__item">Dashboard</a>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="../sys_admin/system_menu" class="side-menu__item active">Menu</a>
                                </li>
                                <li class="slide">
                                    <a href="../sys_admin/users" class="side-menu__item">Users</a>
                                </li>
                            </ul>
                        </li>
