...
def build_sql_prompt(question: str, schema_context: str, memory_context: str, row_limit: int) -> str:
    return f"""
...
def build_sql_retry_prompt(question: str, schema_context: str, row_limit: int) -> str:
    return f"""
