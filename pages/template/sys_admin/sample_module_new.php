...
$pageAuth = hyphen_bind_page_auth('sys_admin/sample_module_new');

include_once '../../../include/h_main.php';
?>
<!-- Start::content -->
<form id="createSampleModuleForm">
    <div class="row">
        <div class="col-xl-8">
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-title">Create Sample Record</div>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label for="recordCode" class="form-label">Code</label>
                        <input type="text" class="form-control" id="recordCode" name="record_code" placeholder="Replace with your real field name" required>
                    </div>
                    <div class="mb-3">
                        <label for="recordName" class="form-label">Name</label>
                        <input type="text" class="form-control" id="recordName" name="record_name" placeholder="Replace with your real field name" required>
                    </div>
                    <div class="mb-0">
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('createSampleModuleForm');
    ...
    form.addEventListener('submit', function(event) {
        ...
        postRequest(formData)
            .then(function(payload) {
                showSuccess(payload.message || 'Record created successfully.').then(function() {
